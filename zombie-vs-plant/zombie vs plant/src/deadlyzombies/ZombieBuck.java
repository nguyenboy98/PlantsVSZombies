...
public class ZombieBuck extends Object {
...
if(HEALTH==05) {Image i=Toolkit.getDefaultToolkit().getImage("./res/dieX.png");  
                g.drawImage(i, x-10, y, 100, 100, null);
                }
else { Image i=Toolkit.getDefaultToolkit().getImage("./res/buck2.gif");  
        g.drawImage(i, x-10, y, 100, 100, null);}
